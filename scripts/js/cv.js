...
/*document.addEventListener('DOMContentLoaded', function () {
    ...
    // Sync editor content with hidden input before form submission
    document.querySelector('form').addEventListener('submit', function() {
        const editorContent = editor.innerHTML;
        document.getElementById('study-description').value = editorContent;
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Sync editor2 content with hidden input before form submission
    document.querySelector('form').addEventListener('submit', function() {
        const editorContent2 = editor2.innerHTML;
        document.getElementById('job_roles').value = editorContent2;
    });
});
*/
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    editors.forEach(editor => {
        const hiddenInput = editor.nextElementSibling; // Assuming the hidden input is immediately after the editor
        ...
        // Sync editor content with the hidden input before form submission
        document.querySelector('form').addEventListener('submit', function() {
        ...
        const newCard = $(`
            <div class="skill-card text-right" id="${type}Card-${cardCount}">
                <div class="header d-flex justify-content-between align-items-center">
                    <span>${type === 'skill' ? 'المهارة' : type === 'language' ? 'اللغة' : 'المهارات'} [${cardCount}]</span>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="${type}Input${cardCount}">${type === 'skill' ? 'المهارة' : type === 'language' ? 'اللغة' : 'المهارات'}</label>
